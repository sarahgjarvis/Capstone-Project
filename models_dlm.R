...
source("~/Desktop/Climate Model Data/dlm_fit.R")
source("~/Desktop/Climate Model Data/make_ts.R")
...
df.trend <- c(rep(0.96, 2), rep(0.94, 2), rep(0.99, 2), rep(0.99, 2))
...
for(i in 1:length(data)){
  for (t in 1:360){
    ...
    dist <- rpearsonVII(10000, dlm$n[360], t.mean, sqrt(t.var))
...
{x <- 1:360
  ...
  {#plot.ts(miroc.global.control[,1])
    plot.ts(miroc.dlm.list$miroc.global.control$m[,1], ylim = c(286,288.7), lwd=1.5, col='green', main='Global', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
  ...
  {#plot.ts(miroc.trop.control[,1])
    plot.ts(miroc.dlm.list$miroc.trop.control$m[,1], lwd=1.5, col='green', ylim = c(297.5,300.5), main='Tropical', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
  ...
  {#plot.ts(miroc.north.control[,1])
    plot.ts(miroc.dlm.list$miroc.north.control$m[,1], ylim = c(286,289), lwd=1.5, col='green', main='Northern', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
  ...
  {#plot.ts(miroc.south.control[,1])
    plot.ts(miroc.dlm.list$miroc.south.control$m[,1], ylim = c(285.5, 288.5), lwd=1.5, col='green', main='Southern', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
  ...
  mtext(c('NCEP', 'ERA', 'Decadal', 'Historical', 'Control'), adj = c(0.43, 0.46, 0.495, 0.545, 0.59), outer = TRUE, cex = 0.8, col = c('black', 'purple', 'red', 'blue', 'green'))
}
...
plot.ts(can.dlm.list$can.global.control$m[,1], ylim = c(286,288.5), lwd=1.5, col='green', main='Global', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
{#plot.ts(can.trop.control[,1])
  plot.ts(can.dlm.list$can.trop.control$m[,1], lwd=1.5, col='green', ylim = c(297.5,300.5), main='Tropical', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
  axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
{#plot.ts(can.north.control[,1])
  plot.ts(can.dlm.list$can.north.control$m[,1], ylim = c(286,289), lwd=1.5, col='green', main='Northern', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
  axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
{#plot.ts(can.south.control[,1])
  plot.ts(can.dlm.list$can.south.control$m[,1], ylim = c(285.5, 288.5), lwd=1.5, col='green', main='Southern', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
  axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
{#plot.ts(had.global.control[,1])
  plot.ts(had.dlm.list$had.global.control$m[,1], ylim = c(286, 288.5), lwd=1.5, col='green', main='Global', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
  axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
  ...
  lines(had.dlm.list$had.global.deca$m[,1], lwd=1.5, col='red')
  ...
  lines(had.dlm.list$had.global.hist$m[,1], lwd=1.5, col='blue')
...
{#plot.ts(had.trop.control[,1])
  plot.ts(had.dlm.list$had.trop.control$m[,1], lwd=1.5, col='green', ylim = c(297.5,300.5), main='Tropical', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
  axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
{#plot.ts(had.south.control[,1])
  plot.ts(had.dlm.list$had.south.control$m[,1], ylim = c(285.5, 288.5), lwd=1.5, col='green', main='Southern', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
  axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
data <- list(gfdl.global.control=gfdl.global.control, gfdl.global.hist=gfdl.global.hist, gfdl.trop.control=gfdl.trop.control, gfdl.trop.hist=gfdl.trop.hist, gfdl.north.control=gfdl.north.control, gfdl.north.hist=gfdl.north.hist, gfdl.south.control=gfdl.south.control, gfdl.south.hist=gfdl.south.hist)

df.trend = list(0.94, 0.94, 0.91, 0.91, 0.99, 0.99, 0.99, 0.99)
...
{x <- 1:360
  ...
  {#plot.ts(gfdl.global.control[,1])
    plot.ts(gfdl.dlm.list$gfdl.global.control$m[,1], ylim = c(286,288.5), lwd=1.5, col='green', main='Global', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
  ...
  {#plot.ts(gfdl.trop.control[,1])
    plot.ts(gfdl.dlm.list$gfdl.trop.control$m[,1], lwd=1.5, col='green', ylim = c(297.5,300.5), main='Tropical', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
  ...
  {#plot.ts(gfdl.south.control[,1])
    plot.ts(gfdl.dlm.list$gfdl.south.control$m[,1], ylim = c(285.5, 288.5), lwd=1.5, col='green', main='Southern', ylab = 'ave temp (K)', xlab = 'time (years)', xaxt="n")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
#Global
{
  #Decadal
  {
    ...
    #remove GFDL decadal because concatenation has jump
...
#Northern
{
  ...
  #control
  {
    plot.ts(miroc.dlm.list$miroc.north.control$m[,1], lwd=1.5, col='green',ylim=c(286, 289), main='', xaxt="n", ylab="ave temp (K)")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
...
#Southern
{
  #Decadal
  {
    plot.ts(miroc.dlm.list$miroc.south.deca$m[,1], lwd=1.5, col='red', main='', ylim=c(285, 288.5), xaxt="n", ylab="ave temp (K)")
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
    polygon(c(rev(x), x), c(rev(miroc.quan.list$miroc.south.deca[ ,3]), miroc.quan.list$miroc.south.deca[ ,1]), col =rgb(225,0,0, max= 225, alpha=50), border = NA)
  ...
  #historical
  {
    plot.ts(miroc.dlm.list$miroc.south.hist$m[,1], lwd=1.5, col='blue', main='Southern', xaxt="n", ylab="ave temp (K)", ylim=c(285, 288.5))
    axis(1, c(1, 120, 240, 360), labels = c("1981", "1991", '2001', '2011'))
